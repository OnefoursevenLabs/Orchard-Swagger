...
{
    public sealed class SwaggerHttpParsedRoute
    {
        private IList<SwaggerPathSegment> _pathSegments;

        public SwaggerHttpParsedRoute(IList<SwaggerPathSegment> pathSegments)
        {
        ...
        private static bool ForEachParameter(IList<SwaggerPathSegment> pathSegments, Func<SwaggerPathParameterSubSegment, bool> action)
        {
            for (int i = 0; i < pathSegments.Count; i++)
            {
                SwaggerPathSegment pathSegment = pathSegments[i];
        ...
        private static SwaggerPathParameterSubSegment GetParameterSubsegment(IList<SwaggerPathSegment> pathSegments, string parameterName)
        {
            SwaggerPathParameterSubSegment foundParameterSubsegment = null;

            ForEachParameter(pathSegments, delegate (SwaggerPathParameterSubSegment parameterSubsegment)
            {
